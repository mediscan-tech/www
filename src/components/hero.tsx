      ...
      <div className="max-w-6xl px-4 mx-auto sm:px-6">
        ...
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <div className="pb-12 text-center md:pb-16">
            <h1 className="mb-4 text-5xl font-extrabold tracking-tighter md:text-6xl leading-tighter" data-aos="zoom-y-out">Helathcare at your <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-teal-400">fingertips</span></h1>
