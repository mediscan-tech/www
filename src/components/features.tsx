                ...
                <div className="relative flex flex-col text-center lg:text-right" data-aos="zoom-y-out" ref={tabs}>
                  ...
                  >
                    <div className="relative inline-flex flex-col">
                      <Image className="mx-auto rounded md:max-w-none" src={"/images/features-bg.png"} width={500} height="462" alt="Features bg" />
                      <Image className="absolute left-0 w-full transform md:max-w-none animate-float" src={"/images/features-element.png"} width={500} height="44" alt="Element" style={{ top: '30%' }} />
                    </div>
                  </Transition>
                  {/* Item 2 */}
                  <Transition
